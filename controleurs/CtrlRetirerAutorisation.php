    ...
    else
    {
        ...
        if ( ! isset ($_POST ["btnRetirerAutorisation"]) ) {
            ...
            if ( ! $ok ) {
                ...
                $message = "Problème lors de la suppression de l'autorisation !";
                ...
                if ($texteMessage == '') {
                    ...
                    if ( ! $ok ) {
                        ...
                        $message = "Autorisation supprimée.<br>L'envoi du courriel de notification a rencontré un problème  !";
                        $typeMessage = 'avertissement';
                        $themeFooter = $themeProbleme;
                        unset($dao);		// fermeture de la connexion à MySQL
                        include_once ('vues/VueRetirerAutorisation.php');
